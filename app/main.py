...
css_content = load_css("app/style.css")
...
DEV_PASSWORD = os.getenv("DEV_PASSWORD", "default_fallback_if_missing")
...
if st.session_state.get("authentication_status"):
    ...
    with text_col:
        ...
        <div style="text-align:center; margin-top:-4rem; margin-bottom:2rem;">
            ...
            <div class="login-logo" style="font-family:'Barlow Condensed',sans-serif;
...
# ============================================
    ...
    if uploaded_file is not None:
        try:
            ...
            # Check for missing columns and fail if any are missing
            missing_cols = set(feature_names) - set(score_df.columns)
            if missing_cols:
                st.error(f"❌ Error: Your CSV is missing {len(missing_cols)} required columns.")
